...
Files:
  ...
  image_data.h - image file converted to a C language array of RGB values
    ...
    with open('image_data.h', 'w') as fout:
      ...
      print('}\n', file=fout)
  labels2.h - names of object classes
  ei-embeddedcvonline-transfer-learning-tensorflow-lite-int8-quantized-model.tflite - TensorFlow Lite model quantized from Edge Impulse (file was renamed/changed to .tflite after download)
    (source for detailed instructions: https://www.hackster.io/franknwachukwuononye/rock-paper-scissors-with-the-maaxboard-rt-a701b5)
  ...
  model/model2_data.h - model data from the .tflite file
...
Detection threshold: *currently not accurate
Expected category: rock, paper, scissors, background
Model: ei-embeddedcvonline-transfer-learning-tensorflow-lite-int8-quantized-model
